...
本地重建审计已达到 12 个中国独立发布机构和 3 个国际发布机构，且内容日期均在 90 天内。首轮 GitHub source audit 实测为中国 10/12、国际 3/3，失败准入源为金域医学和镁信健康；已改用本地实测健康且内容更新的北京市卫生健康委、北京市医疗保障局作为准入源。替换后的无模型、无部署云端复审通过后，才启动 2026-07-17—2026-08-15 的 30 天基线。
