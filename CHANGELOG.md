...
- 医疗健康行业验证新增“事实 Event + 观点 Viewpoint”双通道：热门观点按观点、分析、预测分类并保留原始出处，方舟 `glm-5.2` 只在最多 40 条已通过领域筛选的材料上做中文聚类，不能改写事实状态或编造热度；传播热度只由真实互动、多来源、作者与平台证据确定。首页新增观点脉冲、模型运行与 token 记录，并把事实与观点合并为可人工评审的 Top 10。中文来源结构同时增加国家数据局专家解读、36氪公开 Feed 和 HIT 专家网，新增来源保持 shadow-first 并通过逐源 fixture、失败契约和真实来源审计。
