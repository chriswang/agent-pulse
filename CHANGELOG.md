...
- 重建可独立升级的“医疗健康数据要素”公开行业包：30 个治理信源中 24 个中国来源、6 个国际来源；本地真实审计 24 个健康，90 天新鲜度与发布机构去重后有 12 个中国、3 个国际发布机构通过准入。首轮 GitHub 无模型审计仅达 10/12，已用可稳定访问且内容更新的北京市卫生健康委、北京市医疗保障局替换两个失败准入源，云端复审通过前不启动 30 天基线。
